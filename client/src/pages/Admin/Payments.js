...
import PaymentList from "../../components/admin/PaymentList.js";
...
const Payments = () => {
  ...
  const fetchStatusOptions = async () => {
    try {
      ...
      // Fetch all payments to extract unique status values
      const payments = await ApiHandler.get("/Payments", {
      ...
      if (Array.isArray(payments) && payments.length > 0) {
        ...
        console.log("No payments found or invalid response format");
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
          <div className="mb-4 md:mb-0">
            <h1 className="text-xl font-bold mb-2 flex items-center">
              <FaFileInvoiceDollar className="mr-2" /> Payment Management
            </h1>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-end">
              ...
              <div className="flex-grow">
                <label className="block text-sm font-medium mb-1 text-blue-100">
                  Search Transaction or Renter
                </label>
                <div className="relative">
                  <input
                    type="text"
                    placeholder="Enter transaction ID or renter name"
                    value={searchTerm}
      ...
      >
        {token ? (
          ...
          <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200 text-yellow-700 my-4 shadow-sm">
            ...
            <p>Please sign in to access payment management features.</p>
          </div>
        )}
      </div>
    </div>
